  ...
  return (
    <div className="mt-7">
      ...
      <div className="flex justify-between items-center mb-5">
        {/* Categories */}
        <div className="md:space-x-2  dark:text-white text-opacity-80 p-4 md:p-0 space-y-2 md:space-y-0 flex flex-wrap items-center">
          <button
            onClick={() => setActiveCategory('')} // Clear category filter
            className={`px-5 py-1 rounded-full border  hover:bg-gray-100 transition ${!activeCategory ? 'bg-gray-200 font-bold dark:text-black' : ''
              }`}
          >
            All
          </button>
          {categories.map((category, index) => (
            <button
              ...
              className={`px-5 py-1 rounded-full border text-opacity-80 dark:hover:text-black hover:bg-gray-100 transition ${activeCategory === category ? 'bg-gray-200 font-bold dark:text-black' : ''
                }`}
            >
              {category}
            </button>
