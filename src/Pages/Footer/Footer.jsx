...
const Footer = () => {
  return (
    <div>
      <section className="bg-[#c1bfbec2] mt-10">
        <aside className="">
          <menu className="flex justify-evenly items-center">
            {/* <div className="w-1/3 h-[5px] bg-white"></div> */}
            <div className="text-white font-bold flex items-end"> <span className="font-bold text-black text-5xl">T</span> <small className="text-[hsl(249,100%,72%)] text-3xl"> volu</small>  </div>
            {/* <div className="w-1/3 h-[5px] bg-white"></div> */}
          </menu>

          <menu id="content" className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-1 py-5 lg:justify-items-center items-center">
            <div className="grid grid-cols-2 gap-4">
              <p> <Link className="underline" to={'/'}>Home</Link></p>
              <p> <Link className="underline" to={'/need'}>Need Volunteer</Link></p>
              <p> <Link className="underline" to={'/managepost'}>Manage My Post</Link></p>
              <p> <Link className="underline" to={'/addvolunteer'}>Add Volunteer</Link></p>
            ...
            <div>
              ...
              Tvolu is a comprehensive volunteer management platform designed to streamline the process of recruiting, organizing, and coordinating volunteers for various causes and events. 
