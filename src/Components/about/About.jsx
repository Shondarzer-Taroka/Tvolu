...
export default function About() {
 ...
 const faqRef = useRef(null);
  ...
  const handleScroll = () => {
    ...
    const faqBottom = faqRef.current?.offsetTop + faqRef.current?.offsetHeight;
    const direction = scrollY > lastScrollY ? 'down' : 'up';

    if (scrollY > faqBottom && direction === 'down') {
      setShowParallax(true);
    } else if (direction === 'up' && scrollY < faqBottom) {
