...
function FAQ() {
  ...
  return (
    <div className="md:h-[700px] py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-900/50 dark:to-gray-800/50 backdrop-blur-sm">
